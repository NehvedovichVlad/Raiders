...
public class LoadExcelCharacter : MonoBehaviour
{
    enum Description {
        Name,
        FieldSize,
    ...
    [MenuItem("Utilities/Generate Character")]
    public static void LoadCharacterInfoData(){

        // Read CSV files
        List<Dictionary<string, object>> data = CSVReader.Read("CharacterInfoDatas");
        for (var i = 0; i < data.Count ; i++)
        {
            ...
            AssetDatabase.CreateAsset(character, $"Assets/Resources/Characters/{character.Name}.asset");
        }
    }
